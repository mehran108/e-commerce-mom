...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/make', title: 'Make', icon: 'ft-layers', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/model', title: 'Model', icon: 'ft-list', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/engine', title: 'Engine', icon: 'ft-monitor', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/type', title: 'Type', icon: 'ft-layout', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    ...
    { path: '/business-info', title: 'Business Information', icon: 'ft-file-text', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
